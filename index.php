...
use app\controller\{AdminController , ChangePasswordController, CommentController, ContactController , DiaryController , HomeController, ServicesController , UserController};
...
$router->addRoute('GET' , '/diary/:q' , fn ($q) => "soon");
